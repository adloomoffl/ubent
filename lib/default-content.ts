...
export const defaultContent: SiteContent = {
  ...
  news:[{id:'beginning',title:'A new home for stories in Kochi.',category:'OUR BEGINNING',date:'2026',image:'/assets/ub-logo.png',body:'UB Entertainment is established in Kochi, Kerala. Our story begins with movies, short films, music videos, and a belief in the power of storytelling.'}],
  contact:{location:'Kochi, Kerala',email:'',phone:'+91 95398 66838',whatsapp:'+91 95398 66838',instagram:'',youtube:''},
};
